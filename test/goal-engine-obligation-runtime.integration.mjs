...
function observationHost(cwd, { code = "PASS", receiptRoot = join(cwd, ".state/goal-engine"), receiptPath = receiptRoot, allocation = "normal", artifactMode = 0o600, artifactSymlink = false, holdProcess = false, holdTerminal = false } = {}) {
