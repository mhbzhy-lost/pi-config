 ...
 *
 * Usage:
 *   node render-graphs.ts <skill-directory>           # Render each diagram separately
 *   node render-graphs.ts <skill-directory> --combine # Combine all into one diagram
 *
...
function printUsage() {
  console.error("Usage: node render-graphs.ts <skill-directory> [--combine]");
  console.error("\nOptions:");
  console.error("  --combine    Combine all diagrams into one SVG");
  console.error("\nExample:");
  console.error("  node render-graphs.ts ../some-skill");
  console.error("  node render-graphs.ts ../some-skill --combine");
}
