...
function observationRecorded(p, data) {
  ...
  // Supporting evidence is the current consecutive PASS streak; history stays complete.
  if (verdict.kind !== "passed") { condition.supportingEvidenceIds = []; condition.status = "blocked"; }
